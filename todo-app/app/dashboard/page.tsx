    ...
    <div className="grid gap-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-600 dark:text-slate-400">Let's make today productive</p>
        </div>
        <Button
      ...
      {isFormOpen && (
        <Card className="border-purple-100 dark:border-purple-900/50 bg-white dark:bg-slate-900 shadow-xl shadow-purple-500/5">
          <CardHeader className="pb-2">
            ...
            <CardDescription>Create a new task to boost your productivity</CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        <Card className="border-purple-100 dark:border-purple-900/50 bg-white dark:bg-slate-900 shadow-xl shadow-purple-500/5 overflow-hidden">
          ...
          <CardHeader className="pb-2">
            <CardTitle className="text-purple-700 dark:text-purple-400">Task Overview</CardTitle>
          ...
          <CardContent>
            ...
            <div className="mt-4 space-y-2">
              <div className="flex items-center justify-between text-sm">
                ...
                <span className="font-medium text-purple-700 dark:text-purple-400">{completionRate}%</span>
              </div>
              <Progress
                value={progress}
        ...
        <Card className="border-purple-100 dark:border-purple-900/50 bg-white dark:bg-slate-900 shadow-xl shadow-purple-500/5 overflow-hidden">
          ...
          <CardHeader className="pb-2">
            <CardTitle className="text-blue-600 dark:text-blue-400">Quick Stats</CardTitle>
          ...
          <CardContent>
            <div className="grid grid-cols-2 gap-4">
              <div className="rounded-lg border border-purple-100 dark:border-purple-900/50 bg-purple-50 dark:bg-purple-900/20 p-3 transition-transform hover:scale-105">
                ...
                <div className="text-2xl font-bold text-purple-700 dark:text-purple-400">{tasks.length}</div>
              </div>
              <div className="rounded-lg border border-blue-100 dark:border-blue-900/50 bg-blue-50 dark:bg-blue-900/20 p-3 transition-transform hover:scale-105">
                <div className="text-sm font-medium text-slate-600 dark:text-slate-400">Completion Rate</div>
        ...
        <Card className="border-purple-100 dark:border-purple-900/50 bg-white dark:bg-slate-900 shadow-xl shadow-purple-500/5 overflow-hidden">
          ...
          <CardHeader className="pb-2">
            <CardTitle className="text-green-600 dark:text-green-400">Profile Summary</CardTitle>
      ...
      <Card className="border-purple-100 dark:border-purple-900/50 bg-white dark:bg-slate-900 shadow-xl shadow-purple-500/5">
        <CardHeader className="pb-2">
          ...
          <CardDescription>Manage your tasks and boost productivity</CardDescription>
        </CardHeader>
        <CardContent>
